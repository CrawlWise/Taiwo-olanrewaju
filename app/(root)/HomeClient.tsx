...
export default function HomeClient({ latestPosts }: HomeClientProps) {
  return (
    <div className="flex flex-col min-h-screen overflow-x-hidden">
      ...
      <section className="py-24 bg-white relative overflow-hidden animate-fade-up">
        <div className="container mx-auto px-4 relative z-10">
          ...
          {!latestPosts || latestPosts.length === 0 ? (
            <div className="text-center py-12 text-muted-foreground">
              <p>No articles found. Stay tuned for insights coming soon!</p>
            </div>
          ) : (
              ...
              {latestPosts.map((post, i) => {
                ...
                return (
                  <Link
                    ...
                    className="home-blog-card group"
                  ...
                  >
                    ...
                    <div className="home-blog-card-image-wrap">
                      ...
                      {post.categories && post.categories.length > 0 && (
                        <div className="absolute top-3 left-3 z-10">
                          <span className="blog-tag-primary py-0.5 px-2 text-[10px]">
                    ...
                    <div className="home-blog-card-body">
                      ...
                      <h3 className="home-blog-card-title line-clamp-2">
                        {post.title}
                      </h3>

                      {post.excerpt && (
                        <p className="home-blog-card-excerpt line-clamp-2">
                          {post.excerpt}
                        </p>
                      )}
                    </div>

                    {/* Subtle Read More Row */}
                    <div className="flex items-center justify-between px-5 py-2.5 text-[11px] font-bold text-burgundy bg-warm-beige/10 border-t border-border/50 transition-colors group-hover:bg-burgundy/5 group-hover:text-gold">
